...
public class DownloadTracker {
  ...
  private DownloadHelper getDownloadHelper(Uri uri, String extension, RenderersFactory renderersFactory) {
     ...
     return DownloadHelper.forMediaItem(context, mediaItem, renderersFactory, dataSourceFactory);
  }
  ...
  private final class StartDownloadDialogHelper
    ...
    public void onPrepared(DownloadHelper helper) {
      ...
      trackSelectionDialog = TrackSelectionDialog.createForMappedTrackInfoAndParameters(/* titleId= */ R.string.track_selection_title, mappedTrackInfo, trackSelectorParameters,
    ...
    public void onClick(DialogInterface dialog, int which) {
      DefaultTrackSelector.Parameters.Builder parametersBuilder = trackSelectorParameters.buildUpon();
      for (int periodIndex = 0; periodIndex < downloadHelper.getPeriodCount(); periodIndex++) {
        ...
        downloadHelper.addTrackSelection(periodIndex, parametersBuilder.build());
      }
