...
public class ModakflixAdaptivePlayer extends Application {
    ...
    public DataSource.Factory buildDataSourceFactory() {
        DefaultDataSource.Factory upstreamFactory = new DefaultDataSource.Factory(this, buildHttpDataSourceFactory());
    ...
    private synchronized void initDownloadManager() {
        if (downloadManager == null) {
            ...
            downloadManager = new DownloadManager(
                    this, 
                    downloadIndex, 
                    new DefaultDownloaderFactory(cacheDataSourceFactory));
